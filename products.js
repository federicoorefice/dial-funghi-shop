...
const RECIPES = [
  ...
  /* ── FUNGHI SECCHI ── */
  {
    id: 'funghi-risotto-classico',
    title: 'Risotto ai porcini classico',
    subtitle: 'Il piatto della tradizione, immutabile',
    image: 'IMMAGINI /fior di funghi prodotti /ricetta copia /Gemini_Generated_Image_osilslosilslosil.png',
    time: '30 min',
    difficulty: 'Medio',
    servings: 4,
    gusto: 'funghi-secchi',
    ...
    ingredients: ['320g riso Carnaroli', '30g Porcini Secchi Speciali Dial', 'scalogno', 'vino bianco secco', 'brodo vegetale', 'burro', 'parmigiano grattugiato'],
    steps: ['Ammollare i porcini in acqua tiepida per 20 min, conservare il liquido.', 'Soffriggere lo scalogno nel burro.', 'Tostare il riso 2 min, sfumare con il vino.', 'Aggiungere porcini e liquido filtrato, poi brodo a mestoli.', 'Mantecare con burro e parmigiano a fuoco spento.']
  },
  {
    id: 'funghi-pasta-bianco',
    title: 'Pasta e funghi in bianco',
    subtitle: 'Il profumo dei boschi in 20 minuti',
    image: 'IMMAGINI /fior di funghi prodotti /ricetta copia /Gemini_Generated_Image_1o4ba91o4ba91o4b.png',
    time: '20 min',
    difficulty: 'Facile',
    servings: 4,
    gusto: 'funghi-secchi',
    ...
    ingredients: ['400g tagliatelle', '20g Funghi Misti Secchi Dial', 'aglio', 'vino bianco', 'prezzemolo fresco', 'olio EVO', 'parmigiano'],
    steps: ['Ammollare i funghi 20 min, conservare il liquido filtrato.', 'Soffriggere aglio in olio, aggiungere funghi e sfumare con vino.', 'Aggiungere il liquido di ammollo e ridurre.', 'Cuocere la pasta e saltarla nella salsa.', 'Servire con prezzemolo e parmigiano.']
  },
  {
    id: 'funghi-tagliatelle-ragu',
    title: 'Tagliatelle al ragù di funghi',
    subtitle: 'Comfort food da osteria, fatto in casa',
    image: 'IMMAGINI /fior di funghi prodotti /ricetta copia /Gemini_Generated_Image_szkvvoszkvvoszkv.png',
    time: '35 min',
    difficulty: 'Medio',
    servings: 4,
    gusto: 'funghi-secchi',
    ...
    ingredients: ['400g tagliatelle fresche', '40g Funghi Secchi Misti Dial', 'pomodoro pelato', 'cipolla', 'aglio', 'parmigiano', 'olio EVO'],
    steps: ['Reidratare i funghi 20 min, conservare il liquido.', 'Soffriggere cipolla e aglio, aggiungere funghi.', 'Aggiungere pomodoro e liquido funghi, cuocere 20 min.', 'Cuocere le tagliatelle e condire con il ragù.', 'Servire con parmigiano abbondante.']
  },
  {
    id: 'funghi-zuppa-misti',
    title: 'Zuppa di funghi misti',
    subtitle: 'Calore e profumo di bosco in una ciotola',
    image: 'IMMAGINI /fior di funghi prodotti /ricetta copia /Gemini_Generated_Image_osilslosilslosil.png',
    time: '25 min',
    difficulty: 'Facile',
    servings: 4,
    ...
    ingredients: ['50g Funghi Secchi Misti Dial', '1L brodo vegetale', 'timo fresco', 'aglio', 'olio EVO', 'crostini di pane (opzionali)'],
    steps: ['Reidratare i funghi 20 min nel brodo tiepido.', 'Soffriggere aglio in olio, aggiungere funghi con il brodo.', 'Cuocere con timo per 15 min.', 'Frullare parzialmente per una consistenza cremosa.', 'Servire con crostini e un filo di olio.']
  }
];
